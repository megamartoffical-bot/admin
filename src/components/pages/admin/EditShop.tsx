...
export default function EditShop() {
 ...
 const router = useRouter()
  const { data: shopData, isLoading: shopLoading, refetch } =
  ...
  return (
    <div className="w-full mx-auto md:p-6 bg-gray-50 min-h-screen overflow-y-hidden">
