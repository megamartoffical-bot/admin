...
import { Plus, Search, Filter, Store, Star, Package, UserCheck } from "lucide-react";
...
export default function VendorListPage() {
  ...
  const itemsPerPage = 6; // Vendors per page

  useEffect(() => {
    const fetchVendors = async () => {
      const data: Vendor[] = [
        { name: "TechSupply Co.", contactName: "Michael Brown", email: "orders@techsupply.com", phone: "+1 (555) 111-2222", location: "San Francisco, CA", status: "Active", rating: 4.8, products: 45 },
        { name: "Office Essentials", contactName: "Jennifer White", email: "sales@officeessentials.com", phone: "+1 (555) 222-3333", location: "Chicago, IL", status: "Active", rating: 4.6, products: 67 },
        { name: "Global Electronics", contactName: "Robert Taylor", email: "info@globalelectronics.com", phone: "+1 (555) 333-4444", location: "New York, NY", status: "Active", rating: 4.9, products: 89 },
        { name: "Furniture Plus", contactName: "Amanda Green", email: "orders@furnitureplus.com", phone: "+1 (555) 444-5555", location: "Los Angeles, CA", status: "Pending", rating: 4.3, products: 23 },
        { name: "Quick Parts", contactName: "James Wilson", email: "support@quickparts.com", phone: "+1 (555) 555-6666", location: "Austin, TX", status: "Inactive", rating: 3.8, products: 34 },
        // Add more vendors if needed for pagination
      ];
      setVendors(data);
    };
    fetchVendors();
  ...
  const avgRating = vendors.length > 0 ? (vendors.reduce((sum, v) => sum + v.rating, 0) / vendors.length).toFixed(1) : "0.0";
