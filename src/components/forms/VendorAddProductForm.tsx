...
interface VendorAddProductFormProps {
    importedData?: any;
}

export default function AddProductForm({ importedData }: VendorAddProductFormProps) {
    ...
    const shopData = allShopData?.filter((shop: any) => {
    ...
    if (shopData.length === 0 && !isShopDataLoading) {
        return (
            <div className="flex flex-col justify-center items-center h-64 gap-4">
                ...
                <p className="text-sm text-gray-400">Please create a shop before adding products.</p>
                            ...
                            <FormItem>
                                ...
                                <Select
                                    onValueChange={(value) => {
                                        ...
                                        if (selectedShop) {
                                            const vendorIdValue = selectedShop.vendorId?._id || selectedShop.vendorId;
                                            form.setValue("vendorId", vendorIdValue || vendor?._id || "");
                                        } else {
